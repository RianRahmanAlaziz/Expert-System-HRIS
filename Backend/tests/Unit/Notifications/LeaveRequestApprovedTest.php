...
class LeaveRequestApprovedTest extends TestCase
{
    use RefreshDatabase;
    ...
    {
        $notification = new LeaveRequestApproved(
    ...
    public function test_it_contains_correct_database_data(): void
    {
        ...
        $notification = new LeaveRequestApproved($leaveRequest);
        ...
        $this->assertSame(
            'Pengajuan cuti Annual Leave Anda telah disetujui.',
            $data['message']
        );
